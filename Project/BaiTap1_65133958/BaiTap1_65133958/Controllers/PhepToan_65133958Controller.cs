...
namespace BaiTap1_65133958.Controllers
{
    public class PhepToan_65133958Controller : Controller
    {
        // GET: PhepToan_65133958
        ...
        [HttpPost]
        public ActionResult UseModel(Models.CalModels cal)
        {
            switch (cal.pt)
            {
